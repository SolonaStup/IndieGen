#!/usr/bin/env node
/**
 * set-token — flip INDIEGEN onto the real $INDIEGEN token in one command.
 *
 ...
 *
 *   <MINT>      Token-2022 mint address of $INDIEGEN (base58)
...
console.log('\x1b[32m✓ $INDIEGEN token wired.\x1b[0m')
