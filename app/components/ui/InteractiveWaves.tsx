 ...
 * Adapted to TypeScript + the INDIEGEN theme (orange on near-black) and
...
interface WavesProps {
  /** Stroke color of the wave lines. Defaults to the INDIEGEN orange, faint. */
  lineColor?: string
...
const Waves = ({
  lineColor = 'rgba(245, 165, 36, 0.16)',
  className = '',
  style,
}: WavesProps) => {
